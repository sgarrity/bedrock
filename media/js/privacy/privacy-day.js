...
;(function($, Hammer) {
    ...
    $(function() {
        ...
        gaTrack(['_trackEvent','/privacy/tips/ Interactions','page load', currentURL, 0, true]);
        ...
        $tipsNavDirect.on('click', 'a', function(e) {
            ...
            // GA tracking
            gaTrack(['_trackEvent', '/privacy/tips/ Interactions', 'tab clicks to', $this.attr('href')]);
        });
        ...
        $('#tips-nav-prev-next').on('click', 'button', function(e) {
            ...
            if (!$this.is(':disabled')) {
                ...
                gaTrack(['_trackEvent', '/privacy/tips/ Interactions', gaAction, '#' + pager.currentPage.id]);
            }
        });
        ...
        $('.share-button').on('click', function() {
            ...
            gaTrack(['_trackEvent','/privacy/tips/ Interactions','Social Share', 'share drop-down ' + pos]);
        });
        ...
        $('a[rel="external"]').on('click', function(e) {
            ...
            gaTrack(['_trackEvent', '/privacy/tips/ Interactions', 'outbound link', href], function() {
